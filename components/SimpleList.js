...
const SimpleList = () => {
  ...
  // 감지할 변수값이 바뀔 때마다 함수가 다시 생성
  // 빈 배열이면 컴포넌트 처음 생길때만 함수가 생성
  ...
  return (
    ...
    >
      {/* JSX Element에 코드를 삽입하려면 {} 삽입 */}
      {
        // 원래 배열의 요소 갯수만큼 요소를 변경하여 return
        // JSX.Element를 return
        // {}, {}, {}
        // ↓ ↓ ↓
        // <>, <>, <>
      ...
      <Text style={{ marginBottom: 10, marginTop: 30, fontWeight: 'bold' }}>
        Selected
      </Text>
